...
export class StaticDataService implements DataInterface{
foods :FoodCorner[] = [
  {
    "id": "1",
    "name": " pepproni",
  ...
  },
  {
    ...
    "tag": ["fries"],
    "description": "French fries, french-fried potatoes, are batonnet or allumette-cut deep-fried potatoes of disputed origins fr[om ]Belgium or France."
  }
]
constructor() { 
  console.log("ds");
...
fetchData<T>(endpoint?: string): Observable<T[]> {
  if (endpoint === 'food'){
    return of(this.foods as T[])
  }
  else if (endpoint === 'users'){
    return of([
      {
        "userName": "khaled",
        "email": "khaledalaaka643@gmail.com",
        "password": "n2KA643n2!!",
        "passwordConfirm": "n2KA643n2!!",
        "id": 1
      },
      {
        "userName": "KhaledAlaa",
        "email": "muhammedadel96@gmail.com",
        "password": "n2KA643n2!!",
        "passwordConfirm": "n2KA643n2!!",
        "id": 2
      },
      ...
      {
        "userName": "mostafaali",
        "email": "mahmoud.zayed0001@gmail.com",
        "password": "n2KA643n2!!",
        "passwordConfirm": "n2KA643n2!!",
        "id": 5
      },
      ...
      {
        "userName": "khaledalaa",
        "email": "khaledalaak369@gmail.com",
        "password": "n2KA643n2!!",
        "passwordConfirm": "n2KA643n2!!",
        "id": 9
      }
  ...
  else if (endpoint === 'slider'){
    return of( [
      {
        "image": "../../../assets/Images/slider1.jpg",
        "type": "Burger",
        "description": "Delicious burgers to satisfy your cravings."
      },
      {
        "image": "../../../assets/Images/slider2.jpg",
        "type": "Pizza",
        "description": "Mouthwatering pizzas for a perfect meal."
      },
      {
        "image": "../../../assets/Images/slider3.jpg",
        "type": "Pasta",
        "description": "Savory pasta dishes made just the way you like."
      }
    ]as T[])
  }
...
getFoodByID(id: string | number | null): Observable<FoodCorner> {
  const food = this.foods.find(f => f.id === String(id));
  if (food) {
    return of(food);
  } else {
    return throwError(() => new Error(`Food with id ${id} not found.`));
  }
}
}
